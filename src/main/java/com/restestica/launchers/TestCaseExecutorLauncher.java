...
public class TestCaseExecutorLauncher extends AbstractLauncher {
  ...
  public TestCaseExecutorLauncher(MainConfiguration configuration) {
    super(configuration);
  }
  ...
  protected void botAction() {
    ...
    String deletePreviousResults =
        PropertyReader.readProperty(propertyFilePath, "deletepreviousresults");
    if (Boolean.parseBoolean(deletePreviousResults)) {
  ...
  private void auxBotAction(RESTestExecutor executor, String propertyFilePath) {
    String allureResultsDirPath =
        PropertyReader.readProperty(propertyFilePath, "allure.results.dir");
    String experimentName = PropertyReader.readProperty(propertyFilePath, "experiment.name");
